...
public class LegalActivityTest {
    ...
    private com.nytimes.android.external.register.legal.LegalActivity testObject;
    ...
    public void setUp() {
        ...
        testObject = (com.nytimes.android.external.register.legal.LegalActivity) controller.get();
