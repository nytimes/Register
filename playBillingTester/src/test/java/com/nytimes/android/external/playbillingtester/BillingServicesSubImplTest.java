...
public class BillingServicesSubImplTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        when(skuDetailsBundleBuilder.skus(anyList(), anyString())).thenReturn(skuDetailsBundleBuilder);
    ...
    public void testGetSkuDetails() {
        ...
        skusBundle.putStringArrayList(GoogleUtil.ITEM_ID_LIST, new ArrayList<String>());
    ...
    public void testAsBinder() {
        assertEquals(testObject, testObject.asBinder());
    }
}
